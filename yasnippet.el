...
;;
;;           Prompts you for a snippet to expand. With prefix arg,
;;           ignore buffer-local and snippet-specific conditions.
;;
;;       M-x yas/visit-snippet-file
;;
;;           Visit an existing, active snippet in a `snippet-mode' buffer.
;;
;;       M-x yas/new-snippet
;;
;;           Pop a new buffer in `snippet-mode' so you can create a
;;           new snippet.
;;
;;       M-x yas/load-snippet-buffer
;;
;;           In `snippet-mode', load a snippet into the active
;;           tables. Bound to "C-c C-c".
;;
;;       M-x yas/tryout-snippet
;;
;;           In `snippet-mode', test a snippet so you can see what it
;;           looks like. Bound to "C-c C-t".
;;
;;       M-x yas/describe-tables
;;
;;           Lists known snippets in a separate buffer.
;;
;;   The `dropdown-list.el' extension is bundled with YASnippet, you
;;   can optionally use it as preferred "prompting method", puting in
